...
const mosques = [
  {
    name: "Sun Moon University Prayer Room",
    area: "Tangjeong-myeon, Asan-si — ON CAMPUS",
    address: "Sun Moon University, 70 Sunmoon-ro 221beon-gil, Tangjeong-myeon, Asan-si",
    hours: "Five daily prayers · Friday Jumu'ah",
    note: "Dedicated Islamic prayer space on campus for the large Muslim student community at SMU. Ask at the International Students Office (국제학생처) for the current room number. No travel needed — walk from your dorm.",
    mapUrl: "https://maps.google.com/?q=Sun+Moon+University+Asan+Korea",
    highlight: true,
    distance: "On campus",
  },
  {
    name: "Cheonan Islamic Prayer Space",
    area: "Cheonan-si, South Chungcheong",
    address: "Cheonan-si, Chungcheongnam-do (near Cheonan station district)",
    hours: "Daily prayers · Friday Jumu'ah",
    note: "The nearest standalone Muslim prayer facility outside campus. Cheonan has a growing Muslim community thanks to multiple universities with international students. Take the campus shuttle or bus from Tangjeong to Cheonan.",
    mapUrl: "https://maps.google.com/?q=halal+mosque+Cheonan+Korea",
    highlight: false,
    distance: "~20 min",
  },
  {
    name: "Daejeon Central Masjid",
    area: "Daejeon, South Chungcheong",
    address: "Daejeon-si, Chungcheongnam-do",
    hours: "Five daily prayers · Friday Jumu'ah · Eid prayers",
    note: "Well-established mosque with a permanent imam. Full wudu facilities. Reachable by intercity bus from Cheonan station in about 30 minutes — the nearest full-feature masjid from Asan.",
    mapUrl: "https://maps.google.com/?q=Daejeon+Masjid+Islamic+Center+Korea",
    highlight: false,
    distance: "~45 min",
  },
  {
    ...
    note: "Heart of Korea's largest Muslim-majority neighbourhood. Serves the huge Bangladeshi, Pakistani, and Muslim expat community in Wongok-dong. Worth a day trip to connect with the South Asian community and eat proper deshi food.",
  ...
  },
  {
    ...
    hours: "Open daily — all five prayers · Eid · Tarawih",
    note: "Korea's largest and most equipped mosque. Full wudu rooms, Islamic library, halal restaurants on every corner. About 1.5 hr from Asan by KTX from Cheonan station. Take subway Line 6 to Itaewon.",
  ...
  },
  {
    ...
    address: "Terminal 1 (4F near Gate 28) & Terminal 2 (3F), Incheon",
    hours: "24 hours — always open",
    note: "Dedicated prayer rooms with Qibla markers and wudu sinks in both terminals. Essential for international flights. Qibla direction is marked on the floor.",
...
const restaurants = [
  {
    name: "SMU Campus Cafeteria — Halal Section",
    area: "Sun Moon University, Tangjeong, Asan-si",
    cuisine: "Korean · International (Halal labelled)",
    note: "The campus cafeteria (학생식당) has halal-labelled meal options specifically for Muslim students. Most affordable daily option — no travel needed. Ask campus staff or the International Office which counter is halal.",
    mapUrl: "https://maps.google.com/?q=Sun+Moon+University+cafeteria+Asan",
    certified: true,
    tag: "On campus",
    krw: "4,000–7,000",
    bdt: "328–574",
  ...
  {
    name: "Cheonan Halal Restaurants",
    area: "Cheonan-si, Chungnam (near Cheonan station)",
    cuisine: "Pakistani · Indian · Middle Eastern · Korean-halal",
    note: "Cheonan, 15–20 min from campus, has a cluster of halal-certified restaurants near the station area. Search '할랄 음식점 천안' on Naver Maps for the most up-to-date listings.",
    mapUrl: "https://maps.google.com/?q=halal+restaurant+천안+Korea",
    certified: true,
    tag: "~20 min",
    krw: "8,000–15,000",
    bdt: "656–1,230",
  ...
  {
    name: "Cheonan University District Halal Eateries",
    area: "Seongjeong-dong / Buldang-dong, Cheonan",
    cuisine: "Pakistani · Bangladeshi · Indian",
    note: "Pakistani and Indian-run halal restaurants around Cheonan's university belt. Rice dishes, biryani, and curries that taste close to home. Ask fellow Muslim students for current recommendations.",
    mapUrl: "https://maps.google.com/?q=Pakistani+Indian+halal+restaurant+Cheonan",
    certified: true,
    tag: "~20 min",
    krw: "7,000–13,000",
    bdt: "574–1,066",
  },
  {
    ...
    area: "Wongok-dong, Ansan-si, Gyeonggi-do",
    cuisine: "Bangladeshi · Pakistani · Indian · Middle Eastern",
    note: "Korea's most famous Muslim food street — an entire block of halal restaurants, deshi food, and South Asian snacks. Worth a day trip. Multiple Bangladeshi restaurants serving hilsa, bhuna, and rice meals that taste exactly like home.",
  ...
  },
  {
    ...
    note: "One of Korea's oldest halal-certified Korean restaurants, steps from Seoul Central Mosque. Great for experiencing Korean food — galbi, bulgogi, bibimbap — without compromising.",
  ...
  },
  {
    ...
    note: "Authentic halal Middle Eastern food in Itaewon. Popular with Muslim expats and students on Seoul day trips. Great shawarma and mezze.",
...
const groceries = [
  {
    name: "E-Mart Asan (이마트 아산)",
    area: "Asan-si, Chungnam — ~10 min from campus",
    note: "Closest major supermarket to Sun Moon University. Good for vegetables, eggs, tofu, instant noodles, and packaged goods. Look for 할랄 (Halal) labels on imported products. Taxi or campus shuttle in 10 min.",
    mapUrl: "https://maps.google.com/?q=이마트+아산+Korea",
  },
  {
    name: "Cheonan Halal Market",
    area: "Cheonan-si, Chungnam — ~20 min",
    note: "Halal grocery stores in Cheonan city stock fresh halal meat, rice, lentils, and basic South Asian spices. Search '할랄 마트 천안' on Naver Maps for current shop locations near Cheonan station.",
    mapUrl: "https://maps.google.com/?q=halal+마트+천안+Korea",
  },
  {
    name: "Daiso (다이소) — Asan/Cheonan",
    area: "Asan-si · Cheonan-si",
    note: "Not a food store, but essential: ₩1,000–5,000 kitchen tools — pots, rice bowls, chopsticks, measuring cups, storage boxes. Every student needs a Daiso run in the first week.",
    mapUrl: "https://maps.google.com/?q=다이소+아산+Korea",
  },
  {
    name: "Ansan Halal Groceries — Wongok-dong",
    area: "Wongok-dong, Ansan-si, Gyeonggi-do — ~1.5 hr",
    note: "Multiple halal grocery stores on Ansan's Multicultural Street. Fresh halal-slaughtered meat, Bangladeshi spices, mustard oil, dried shutki fish, Bangladeshi rice varieties, and snacks from home. Worth a monthly trip.",
    mapUrl: "https://maps.google.com/?q=Halal+grocery+Ansan+Wongokdong+Korea",
  },
  {
    name: "Bangladeshi Grocery Stores — Wongok-dong",
    area: "Wongok-dong, Ansan-si — ~1.5 hr",
    note: "Bangladeshi-run shops stock everything you can't find in Korean supermarkets: turmeric, cumin, coriander, shutki maach, Bangladeshi rice, red lentils, mustard oil, and familiar snacks. Stock up on a single trip.",
